...
$sql = "SELECT p.*, f.facility_id, f.name as facility_name, f.facility_type FROM products p 
        JOIN facilities f ON p.facility_id = f.facility_id
        JOIN business_owners bo ON f.owner_id = bo.owner_id
        WHERE p.product_id = $product_id AND bo.user_id = $user_id";
...
$facility_type = $product['facility_type'];
$message = '';
$messageType = '';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update = "UPDATE products SET 
                ...
                category='$category', stock_status='$stock_status', 
                quantity=$quantity, expiry_date=" . ($expiry_date ? "'$expiry_date'" : "NULL") . ",
                manufacturer='$manufacturer', prescription_required=$prescription
...
<head>
    ...
    <title>Edit Product - PharmaLocator</title>
...
<body>
    ...
    <div class="container">
        <!-- Back Link -->
        <a href="manage_products.php?facility_id=<?php echo $facility_id; ?>" class="btn-back">
            ...
            <form method="POST">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="number" name="price" min="0" step="50" value="<?php echo $product['price']; ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="category">
                            ...
                            <?php
                            $categories = ['Pain Relief','Antibiotics','Vitamins','Cold & Flu','Allergy','Digestive','First Aid','Other'];
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="quantity" min="0" value="<?php echo $product['quantity']; ?>">
                    </div>

                    <div class="form-group">
                        <label><i class="fas fa-calendar-alt"></i> Expiry Date</label>
                        <input type="date" name="expiry_date" value="<?php echo $product['expiry_date']; ?>">
                    </div>
                ...
                <div class="checkbox-group">
                    <input type="checkbox" name="prescription_required" id="prescription" <?php echo $product['prescription_required'] ? 'checked' : ''; ?>>
